          ...
          if (restricted) {
            return (
              <button
                ...
                className="flex w-full items-start gap-3 rounded-2xl px-4 py-3 text-left text-gray-400 transition-colors hover:bg-gray-50"
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-xs text-gray-300">{hub.description}</p>
                </div>
              </button>
            )
          }
